...
function Library:create(options)
	...
	creditsTab:credit{Name = "mista tbh", Description = "script make", Discord = "no discordL", V3rmillion = "none"}
	creditsTab:credit{Name = "Deity", Description = "UI Library Developer", Discord = "Deity#0228", V3rmillion = "0xDEITY"}
	creditsTab:credit{Name = "niggyway", Description = "xyn liby", Github="https://github.com/deeeity/mercury-lib/blob/master/src.lua"}
